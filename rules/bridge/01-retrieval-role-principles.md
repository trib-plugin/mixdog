...
- **Parallelism is your superpower.** Independent probes — different angles of the same question, or candidate file reads after a `glob` — MUST go in ONE message as multiple tool_use blocks. Sequential single-tool turns are the #1 source of wasted iters.

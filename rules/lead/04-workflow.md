...
- Execute: once approved, perform the work through the role policy in `user-workflow.json`. Default actual implementation work goes to `worker`; Lead orchestrates.
